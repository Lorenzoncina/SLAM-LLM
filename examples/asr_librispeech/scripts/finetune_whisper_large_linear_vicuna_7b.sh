...
#output_dir=/stek/lconcina/SLAM-LLM-DVC-/output/vicuna-7b-v1.5-$exp_data-linear-steplrwarmupkeep$learn_rate-wavlm-large-$(date +"%Y%m%d")
...
#output_dir=/stek/lconcina/SLAM-LLM-DVC-/train_output/$llm_name-$exp_data-$encoder_projector-steplrwarmupkeep$learn_rate-$encoder_name-$(date +"%Y%m%d")
